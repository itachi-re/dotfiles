...
# Try system-wide install first, then local fallback
if [[ -f /usr/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh ]]; then
  source /usr/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
elif [[ -f ~/.zsh_plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh ]]; then
...
elif [[ -f ~/.zsh_plugins/zsh-autosuggestions/zsh-autosuggestions.zsh ]]; then
